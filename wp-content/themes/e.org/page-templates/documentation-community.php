<?php // Template Name: Documentation Comunity ?>
<?php
get_header();
...
<div class="container">
	...
	<div class="row arrow-row text-center">
		<div class="col-sm-12">
		...
		<div class="col-sm-4 col-sm-offset-4">
			<div class="doc-box align-col">
				...
				<div class="doc-box-content">
					<h4>Comunity Step 1<br>Basic GRC Relationships</h4>
...
<div class="container">
	<h3 class="text-center margin-top-20">
		<strong>Install &amp; Configuration (30-40 Minutes)</strong>
	</h3>
	<h4 class="doc-subtitle text-center margin-bottom-40">
