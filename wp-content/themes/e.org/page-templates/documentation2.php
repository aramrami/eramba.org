...
<div class="container">
	<h3 class="text-center margin-top-20">
		<strong>Install &amp; Configuration</strong>
	</h3>
	<h4 class="doc-subtitle text-center margin-bottom-40">
	...
	<div class="row align-row">
		...
		<div class="col-sm-4">
			<div class="doc-box align-col">
				...
				<div class="doc-box-content">
					<h4>Configure</h4>
					<p>Follow our configuration guides in detail to make sure the system works well.</p>
					<ul>
						<li><a href="https://docs.google.com/document/d/1D39uXCRfbTMvyVMFsGRyIcob8cSccAn1NWIdREodpms/edit#">Doc</a></li>
						<li><a class="fancybox fancybox.iframe" href="http://www.youtube.com/embed/a1KFzgFZ9Hs?enablejsapi=1&wmode=opaque">Videos</a></li>
					</ul>
				</div>
			</div>
		</div>
