...
function pipdig_zrf_meta_callback($post) {
	...
	jQuery(document).ready(function($) {
		...
		if (fieldType == 'text') {
			...
			$('.zrf_field_title, .zrf_field_id, .zrf_optional_title, .zrf_field_required, .zrf_field_placeholder, .zrf_field_default, .zrf_field_get, .prefix-and-suffix, .zrf_field_desc_suffix, .zrf_field_pattern').fadeIn(750);
			$('.zrf_field_description, .zrf_field_options').fadeOut(250);
			$('#field-options').removeAttr('required');
			$('#field-title, #field-id').prop('required',true);
			
		} else if (fieldType == 'number') {
			
			$('.zrf_field_title, .zrf_field_id, .zrf_optional_title, .zrf_field_required, .zrf_field_default, .zrf_field_get, .prefix-and-suffix, .zrf_field_desc_suffix').fadeIn(750);
			$('.zrf_field_placeholder, .zrf_field_description, .zrf_field_pattern, .zrf_field_options').fadeOut(250);
			$('#field-options').removeAttr('required');
			$('#field-title, #field-id').prop('required',true);
			
		} else if (fieldType == 'url') {
			
			$('.zrf_field_title, .zrf_field_id, .zrf_optional_title, .zrf_field_required, .zrf_field_placeholder, .zrf_field_default, .zrf_field_get, .prefix-and-suffix, .zrf_field_desc_suffix').fadeIn(750);
			$('.zrf_field_description, .zrf_field_pattern, .zrf_field_options').fadeOut(250);
			$('#field-options').removeAttr('required');
			$('#field-title, #field-id').prop('required',true);
			...
			$('.zrf_field_title, .zrf_field_id, .zrf_optional_title, .zrf_field_required, .prefix-and-suffix').fadeIn(750);
			$('.zrf_field_placeholder, .zrf_field_default, .zrf_field_get, .zrf_field_description, .zrf_field_desc_suffix, .zrf_field_pattern, .zrf_field_options').fadeOut(250);
			$('#field-options').removeAttr('required');
			$('#field-title, #field-id').prop('required',true);
			...
			$('.zrf_field_title, .zrf_optional_title, .zrf_field_required, .zrf_field_placeholder, .zrf_field_description, .zrf_field_pattern, .zrf_field_options').fadeOut(250);
			...
			$('.zrf_field_title, .zrf_field_id, .zrf_optional_title, .zrf_field_required, .zrf_field_placeholder, .zrf_field_default, .zrf_field_get, .prefix-and-suffix, .zrf_field_desc_suffix, .zrf_field_extra_info, .zrf_field_pattern, .zrf_field_options').fadeOut(250);
			...
			$('#field-description').prop('required',true);
				...
				$('.zrf_field_description, .zrf_field_placeholder, .zrf_field_default, .zrf_field_get, .prefix-and-suffix, .zrf_field_desc_suffix, .zrf_field_pattern, .zrf_field_options').fadeOut(250);
				$('#field-options').removeAttr('required');
				$('#field-title, #field-id').prop('required',true);
				...
				$('.zrf_field_description, .zrf_field_placeholder, .prefix-and-suffix, .zrf_field_desc_suffix, .zrf_field_pattern, .zrf_field_get, .zrf_field_default').fadeOut(250);
				$('#field-title, #field-id, #field-options').prop('required',true);
				
		} else {
			
			$('.zrf_field_title, .zrf_field_id, .zrf_optional_title, .zrf_field_required, .zrf_field_placeholder, .zrf_field_default, .zrf_field_get, .zrf_field_description, .prefix-and-suffix, .zrf_field_desc_suffix, .zrf_field_pattern, .zrf_field_options').fadeIn(250);
		...
		$('#field-type').change(function(){
			...
			if (fieldType == 'text') {
				...
				$('.zrf_field_title, .zrf_field_id, .zrf_optional_title, .zrf_field_required, .zrf_field_placeholder, .zrf_field_default, .zrf_field_get, .prefix-and-suffix, .zrf_field_extra_info, .zrf_field_desc_suffix, .zrf_field_pattern').fadeIn(750);
				$('.zrf_field_description, .zrf_field_options').fadeOut(250);
				$('#field-options').removeAttr('required');
				$('#field-title, #field-id').prop('required',true);
				...
				$('.zrf_field_id, .zrf_field_default, .zrf_field_get, .prefix-and-suffix, .zrf_field_desc_suffix').fadeIn(750);
				$('.zrf_field_title, .zrf_optional_title, .zrf_field_required, .zrf_field_placeholder, .zrf_field_description, .zrf_field_extra_info, .zrf_field_pattern, .zrf_field_options').fadeOut(250);
				$('#field-title, #field-options').removeAttr('required');
				$('#field-id').prop('required',true);
				...
				$('.zrf_field_description').fadeIn(750);
				$('.zrf_field_title, .zrf_field_id, .zrf_optional_title, .zrf_field_required, .zrf_field_placeholder, .zrf_field_default, .zrf_field_get, .prefix-and-suffix, .zrf_field_extra_info, .zrf_field_desc_suffix, .zrf_field_pattern, .zrf_field_options').fadeOut(250);
				$('#field-title, #field-idm, #field-options').removeAttr('required');
				$('#field-description').prop('required',true);
				...
				$('.zrf_field_title, .zrf_field_id, .zrf_optional_title, .zrf_field_required, .zrf_field_placeholder, .zrf_field_default, .zrf_field_get, .zrf_field_description, .prefix-and-suffix, .zrf_field_extra_info, .zrf_field_desc_suffix, .zrf_field_pattern, .zrf_field_options').fadeIn(250);
	...
	<p class="zrf_field_type">
		<label for="field-type">Field type (<a href="http://www.w3schools.com/tags/att_input_type.asp" target="_blank">?</a>)</label><br />
	...
	<p class="zrf_field_id">
		...
		<input type="number" name="field-id" id="field-id" value="<?php if (isset($zrf_meta['field-id'])) echo absint($zrf_meta['field-id'][0]); ?>" required />
	...
	<p class="zrf_field_options">
		<label for="field-options">Options - One per line in "tag|Title" pairs. <a href="http://imgur.com/a/OxHIe" target="_blank">Click here</a> for an example</label><br />
	...
	<p class="zrf_field_required">
		<label for="field-required">
			...
			This is a required field (<a href="http://www.w3schools.com/tags/att_input_required.asp" target="_blank">?</a>)
		</label>
	</p>
	<p class="zrf_field_desc_suffix">
		<label for="field-desc-suffix">
			...
			Add data from this field to the description in the created ticket
		</label>
	</p>
	<p class="zrf_field_pattern">
		<label for="field-pattern">HTML5 Pattern (<a href="http://www.w3schools.com/tags/att_input_pattern.asp" target="_blank">?</a>)</label><br />
		<input type="text" name="field-pattern" id="field-pattern" value="<?php if (isset($zrf_meta['field-pattern'])) echo esc_attr($zrf_meta['field-pattern'][0]); ?>" />
	</p>
	...
	<p class="zrf_field_placeholder">
		<label for="field-placeholder">Placeholder (<a href="http://www.w3schools.com/tags/att_input_placeholder.asp" target="_blank">?</a>)</label><br />
	...
	<p class="zrf_field_default">
		...
		<input type="text" name="field-default" id="field-default" value="<?php if (isset($zrf_meta['field-default'])) echo esc_attr($zrf_meta['field-default'][0]); ?>" />
	</p>
	...
	<div class="prefix-and-suffix">
		<h3 style="margin-top: 40px;">Changes to data sent to Zendesk</h3>
...
function pipdig_zrf_meta_save($post_id) {
	...
	if (isset($_POST['field-default'])) {
		update_post_meta( $post_id, 'field-default', sanitize_text_field($_POST['field-default']) );
	}
...
add_action( 'save_post', 'pipdig_zrf_meta_save' );