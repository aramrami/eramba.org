	...
	?>
		<div class="mo2f_table_layout">
			...
			<form name="f"  id="advance_options_form" method="post" action="">
				...
				<p>We will provide you the shortcode and setup the end to end flow of 2nd factor in your customized login form.
				</p><br />
	...
	function show_2_factor_pricing_page($current_user) { ?>
		...
		<tr style="vertical-align:top;">
			<td><div class="mo2f_thumbnail mo2f_pricing_free_tab" >
				...
				<p  class="mo2f_pricing_text">$0 - Subscription Fees<br /><br /><br /></p>
				<hr>
				<p class="mo2f_pricing_text">Features:</p>
				<p class="mo2f_pricing_text">Limited Authentication Methods<br />
				Remember Device<br>
				Two-Factor for Woocommerce Front End Login<br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br />
				<hr>
			...
			<td><div class="mo2f_thumbnail mo2f_pricing_paid_tab">
				...
				<p class="mo2f_pricing_text">$0.5 per MAU - Subscription Fees **<br />
				(Monthly Active User)<br />
				(billed at $6 per user per year)</p>
				<hr>
				<p class="mo2f_pricing_text">Features:</p>
				...
				Enable 2 Factor with various login forms***<br><br><br />
				</p><hr>
				<p class="mo2f_pricing_text">Backup Method:<br />
		...
		<td><div class="mo2f_thumbnail mo2f_pricing_free_tab">
				...
				Shortcode for customzied login form***<br />	
		...
		<h3>** Volume discounts are available. You can check the discount price by clicking on 'Click here to upgrade' button .</h3>
		...
		<p>*** 2 Factor will work with various login forms like Woocommerce, Theme My Login and many more. Shortcode will work only for the customized login page created from wordpress plugins. We are not claiming that 2 Factor will work with all the customized login forms. In such case, custom work is needed to integrate two factor with your customized login page.</p>
