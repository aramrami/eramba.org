...
<div class="wpforo-profile-wrap">
	<?php if( !empty($user) && ( $wpforo->current_userid == $user['userid'] || $wpforo->perm->usergroup_can( $wpforo->current_user_groupid, 'vprf' )) ) : extract($user, EXTR_OVERWRITE); ?>
	    ...
	    <div class="wpforo-profile-head">
	      ...
	      <div class="h-header">
	      	<?php if( wpforo_feature('avatars', $wpforo) ): $rsz =''; ?>
	        	<div class="h-left"><?php echo $wpforo->member->avatar($user, 'alt="'.esc_html($display_name).'"', 150); ?></div>
	        ...
	        <div class="h-right" <?php echo $rsz; //This is a HTML content; ?>>
	             <div class="h-top">
	                ...
	                <div class="profile-stat-data">
                        ...
                        <div class="profile-stat-data-item"><?php wpforo_phrase('Title') ?>: <?php wpforo_member_title($user); ?></div>
	...
	<?php elseif( !empty($user) && !( $wpforo->current_userid == $user['userid'] || $wpforo->perm->usergroup_can( $wpforo->current_user_groupid, 'vprf' )) ) : ?>
		<div class="wpforo-profile-content wpfbg-7">
			<div class="wpforo-messages-content wpfbg-7" style="border: #E6E6E6 1px solid; margin-top:3px;">
