...
#wpf_attach_dialog .wpforo-button-prime{ background-color:'. $WPFCOLOR_32 .'; border:1px solid '. $WPFCOLOR_32 .'; }
#wpf_attach_dialog .wpforo-button-prime:hover{ background-color:'. $WPFCOLOR_33 .'; }
...
#wpf_attach_dialog button.start{ background-color:'. $WPFCOLOR_12 .'; border:1px solid '. $WPFCOLOR_12 .'; }
#wpf_attach_dialog button.start:hover{ background-color:'. $WPFCOLOR_14 .'; }
...
#wpforo-wrap .wpforo-topic-badges i.fa { color: '. $WPFCOLOR_12 .'; }
