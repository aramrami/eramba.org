     	  ...
     	  <tr class="wpf-htr">
            ...
            <?php foreach($posts as $post) : extract($post, EXTR_OVERWRITE); ?>
	          ...
	          <tr class="wpf-ttr">
	            ...
	            <td class="wpf-spost-user"><?php $user = $wpforo->member->get_member($userid, true); echo ( $user['display_name'] ? esc_html($user['display_name']) : esc_html(urldecode($user['user_nicename'])) ); ?></td>
