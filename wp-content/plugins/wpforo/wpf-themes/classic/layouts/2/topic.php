          ...
          <div class="topic-wrap">
              <div class="wpforo-topic">
                  ...
                  <div class="wpforo-topic-info">
                    <p class="wpforo-topic-title"><a href="<?php echo esc_url($wpforo->topic->get_topic_url($topic, $forum)) ?>"><i class="fa fa-1x <?php $wpforo->tpl->icon('topic', $topic); ?>" title="<?php $icon_title = $wpforo->tpl->icon('topic', $topic, false, 'title'); if( $icon_title ) echo esc_html($icon_title) ?>"></i> <?php echo esc_html($topic['title']) ?></a></p>
