...
<div class="wpfl-3">
	...
	<?php foreach($forums as $forum) : 
		...
		$topics = $wpforo->topic->get_topics( array("forumid" => $forum['forumid'], "orderby" => "type, created", "order" => "DESC", "row_count" => $wpforo->forum_options['layout_qa_intro_topics_count'] ) );
							...
							<?php foreach($topics as $topic) : ?>
				                ...
				                <li> 
				                    ...
				                    <div class="wpforo-last-topic-title">
				                    	<a href="<?php echo esc_url($wpforo->topic->get_topic_url($topic, $forum)) ?>"><?php echo esc_html($topic['title']) ?></a><br />
				                    	<span class="wpforo-last-topic-info wpfcl-2"><?php wpforo_phrase('by') ?> <a href="<?php echo esc_url($member['profile_url']) ?>"><?php echo esc_html($member['display_name']) ?></a>, <?php wpforo_date($topic['created']); ?></span>
				                    </div> 
