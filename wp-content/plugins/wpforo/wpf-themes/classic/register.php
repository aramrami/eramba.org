        ...
        <div class="wpforo-register-content">
         <table class="wpforo-register-table wpfcl-1" width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr class="wpfbg-9">
                ...
                <td class="wpf-register-field"><input autofocus required="TRUE" type="text" value="<?php echo esc_attr($user_login) ?>" name="wpfreg[user_login]" class="wpf-register-text wpfw-70" maxlength="15" /></td>
              </tr>
              <tr class="wpfbg-7">
                <td class="wpf-register-label">
